  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? 'bg-[#090d16]/95 backdrop-blur-md border-b border-slate-800/80 py-3 shadow-xl shadow-cyan-950/20'
          : 'bg-[#090d16]/90 lg:bg-transparent backdrop-blur-md lg:backdrop-blur-none border-b border-slate-800/80 lg:border-none py-3 lg:py-5'
      }`}
    >
